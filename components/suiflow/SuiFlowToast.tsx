...
function SuiFlowNotifier({ title , body  , timer , loader,  icon, position, variant, mode} : NotifierProps) {
  ...
  if (hidden) {
   ...
   const animation = 
    ...
    ? 'transaction-notifier-center-top'
    : isMobile && (position === 'bottom-right' || position === 'bottom-left') 
    ? 'transaction-notifier-center-bottom'
    : position === 'top-right'
    ? 'transaction-notifier-top-right'
    : position === 'top-left'
    ? 'transaction-notifier-top-left'
    : position === 'bottom-right'
    ? 'transaction-notifier-bottom-right'
    : position === 'bottom-left'
    ? 'transaction-notifier-bottom-left'
    : 'transaction-notifier-center-right'; // Default
...
export default SuiFlowNotifier;
