    ...
    <div className="flex justify-center items-center">
      <div className="bg-[#0A1428]/80 border border-[#2A3746] relative flex items-center shadow-md rounded-full w-52 h-10">
        ...
        <input
          ...
          aria-label="Search components including Address Display, Balance Display, NFT Card, Object Display, Token Input, Transaction Notifier, and Transaction History"
        />
